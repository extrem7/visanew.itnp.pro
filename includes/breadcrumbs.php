    ...
    <div class="breadcrumbs">
        <div class="container">
            <ul>
				...
				$sep            = '<i class="fa fa-caret-right"></i>'; // разделитель между "крошками"
				...
				$link_in_before = '';
				$link_in_after  = '';
				$link           = $link_before . '<li class="breadcrumb-item"><a href="%1$s"' . $link_attr . '>' . $link_in_before . '%2$s' . $link_in_after . '</a></li>' . $link_after;
				$frontpage_id   = get_option( 'page_on_front' );
				$parent_id      = ( $post ) ? $post->post_parent : '';
				$sep            = ' ' . $sep_before . $sep . $sep_after . ' ';
				$home_link      = $link_before . '<li class="breadcrumb-item"><a href="' . $home_url . '"' . $link_attr . ' class="home">' . $link_in_before . $text['home'] . $link_in_after . '</a></li>' . $link_after;
